...
import view.coverPage1;
//import view.SignUpPanel1;
...
public class ClientFrame extends JFrame implements Runnable {
    ...
    //SignUpPanel1 signUpPanel1;
    RoomPanel roomPanel;
    coverPage1 coverPage1;
    ...
    public ClientFrame(String name) {
        ...
        //signUpPanel1 = new SignUpPanel1();
        roomPanel = new RoomPanel();
        coverPage1 = new coverPage1();
        
        //mainPanel.setSize(570, 450);
        coverPage1.setVisible(true);
        welcomePanel.setVisible(false);
        signUpPanel.setVisible(false);
        //signUpPanel1.setVisible(false);
        loginPanel.setVisible(false);
        roomPanel.setVisible(false);
        clientPanel.setVisible(false);
        
        mainPanel.add(coverPage1);
        ...
        itemChangePass.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(ClientFrame.this, "No code in this section", "ERROR!!", JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    private void addEventsForcoverPage1(){
        coverPage1.continueButton().addActionListener(new ActionListener(){
             @Override
            public void actionPerformed(ActionEvent a) {
                coverPage1.setVisible(false);
   ...
   /* private void addEventsForSignUpPanel1() {
        signUpPanel1.getLbBack_signup().addMouseListener(new MouseAdapter() {
            @Override
        ...
        signUpPanel1.getBtSignUp().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                btSignUpEvent();
            }
...
//    }
    ...
    private void btSignUpEvent() {
       // String pass = this.signUpPanel1.getTfPass().getText();
       // String pass2 = this.signUpPanel1.getTfPass2().getText();
        String pass = this.signUpPanel.getTfPass().getText();
        String pass2 = this.signUpPanel.getTfPass2().getText();
        if(!pass.equals(pass2)) {
            JOptionPane.showMessageDialog(this, "Passwords don't match", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
           // String nickname = signUpPanel1.getTfID().getText().trim();
            //String hostName = signUpPanel1.getTfHost().getText().trim();
